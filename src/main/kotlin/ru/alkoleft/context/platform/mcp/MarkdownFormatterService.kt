...
class MarkdownFormatterService {
     ...
     */
    fun formatSearchResults(query: String, results: List<Any>): String {
        if (results.isEmpty()) {
     ...
     */
    fun formatDetailedInfo(obj: Any): String = when (obj) {
     ...
     */
    fun formatConstructors(constructors: List<ISignature>, typeName: String): String = buildString {
        ...
        constructors.forEachIndexed { index, constructor ->
            ...
            if (constructor.params.isNotEmpty()) {
                ...
                constructor.params.forEach { param ->
                    ...
                    val description = param.description ?: "Описание отсутствует"
     ...
     */
    fun formatTypeMembers(type: PlatformTypeDefinition): String = buildString {
        ...
        if (type.methods.isNotEmpty()) {
            ...
            type.methods.forEach { method ->
                ...
                val description = method.description ?: "Описание отсутствует"
        ...
        if (type.properties.isNotEmpty()) {
            ...
            type.properties.forEach { property ->
                val description = property.description ?: "Описание отсутствует"
    ...
    private fun formatMethodDefinition(method: MethodDefinition): String = buildString {
    ...
    private fun formatPropertyDefinition(property: PropertyDefinition): String = buildString {
    ...
    private fun formatPlatformTypeDefinition(type: PlatformTypeDefinition): String = buildString {
    ...
    private fun formatSingleObject(obj: Any): String = when (obj) {
        is MethodDefinition -> formatMethodDefinition(obj)
        is PropertyDefinition -> formatPropertyDefinition(obj)
        is PlatformTypeDefinition -> formatPlatformTypeDefinition(obj)
        else -> "❌ **Неподдерживаемый тип объекта:** ${obj::class.simpleName}"
    ...
    private fun formatCompactObject(obj: Any, isFirst: Boolean): String = buildString {
